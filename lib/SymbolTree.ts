...
class SymbolTree
{
	 ...
	 */
	insertBefore<T>(referenceObject, newObject: T)
	{
	 ...
	 * @return {Object} newObject
	 */
	insertAfter<T>(referenceObject, newObject: T)
	{
		const referenceNode = this._node(referenceObject);
	 ...
	 * @return {Object} newObject
	 */
	prependChild<T>(referenceObject, newObject: T)
	{
		const referenceNode = this._node(referenceObject);
		const newNode = this._node(newObject);
	 ...
	 * @return {Object} newObject
	 */
	appendChild<T>(referenceObject, newObject: T)
	{
		const referenceNode = this._node(referenceObject);
		const newNode = this._node(newObject);
	...
	static SymbolTreeNode = SymbolTreeNode;
	static TreePosition = TreePosition;
	static TreeIterator = TreeIterator;

	static SymbolTree = SymbolTree;
	static default = SymbolTree;
}
