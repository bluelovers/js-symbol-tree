 ...
 */
const SymbolTreeNode_1 = require("./SymbolTreeNode");
const TreePosition_1 = require("./TreePosition");
const TreeIterator_1 = require("./TreeIterator");
function returnTrue() {
    return true;
}
...
class SymbolTree {
    ...
    _node(object) {
        ...
        return (object[this.symbol] = new SymbolTreeNode_1.default());
    }
    /**
    ...
    childrenIterator(parent, options) {
        ...
        const parentNode = this._node(parent);
        return new TreeIterator_1.default(this, parent, reverse ? parentNode.lastChild : parentNode.firstChild, reverse ? TreeIterator_1.default.PREV : TreeIterator_1.default.NEXT);
    }
    /**
    ...
    previousSiblingsIterator(object) {
        return new TreeIterator_1.default(this, object, this._node(object).previousSibling, TreeIterator_1.default.PREV);
    }
    /**
    ...
    nextSiblingsIterator(object) {
        return new TreeIterator_1.default(this, object, this._node(object).nextSibling, TreeIterator_1.default.NEXT);
    }
    /**
    ...
    ancestorsIterator(object) {
        return new TreeIterator_1.default(this, object, object, TreeIterator_1.default.PARENT);
    }
    /**
    ...
    treeIterator(root, options) {
        const reverse = options && options.reverse;
        return new TreeIterator_1.default(this, root, reverse ? this.lastInclusiveDescendant(root) : root, reverse ? TreeIterator_1.default.PRECEDING : TreeIterator_1.default.FOLLOWING);
    }
    /**
    ...
    compareTreePosition(left, right) {
        ...
        const leftAncestors = [];
        {
            ...
            while (leftAncestor) {
                if (leftAncestor === right) {
                    return TreePosition_1.default.CONTAINS | TreePosition_1.default.PRECEDING;
        ...
        const rightAncestors = [];
        {
            ...
            while (rightAncestor) {
                if (rightAncestor === left) {
                    return TreePosition_1.default.CONTAINED_BY | TreePosition_1.default.FOLLOWING;
                }
        ...
        if (!root || root !== reverseArrayIndex(rightAncestors, 0)) {
            ...
            return TreePosition_1.default.DISCONNECTED;
        }
        ...
        return rightIndex < leftIndex
            ? TreePosition_1.default.PRECEDING
            : TreePosition_1.default.FOLLOWING;
    }
    /**
...
SymbolTree.SymbolTreeNode = SymbolTreeNode_1.default;
SymbolTree.TreePosition = TreePosition_1.default;
SymbolTree.TreeIterator = TreeIterator_1.default;
SymbolTree.SymbolTree = SymbolTree;
SymbolTree.default = SymbolTree;
