...
declare class SymbolTree {
     ...
     */
    insertBefore<T>(referenceObject: any, newObject: T): T;
    /**
     ...
     * @return {Object} newObject
     */
    insertAfter<T>(referenceObject: any, newObject: T): T;
    /**
     ...
     * @return {Object} newObject
     */
    prependChild<T>(referenceObject: any, newObject: T): T;
    /**
     ...
     * @return {Object} newObject
     */
    appendChild<T>(referenceObject: any, newObject: T): T;
    static SymbolTreeNode: typeof SymbolTreeNode;
    static TreePosition: Readonly<{
        DISCONNECTED: number;
        PRECEDING: number;
        FOLLOWING: number;
        CONTAINS: number;
    ...
    static TreeIterator: typeof TreeIterator;
    static SymbolTree: typeof SymbolTree;
    static default: typeof SymbolTree;
}
export = SymbolTree;
